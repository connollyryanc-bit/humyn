...
export const opportunities: Opportunity[] = [
  ...
  },
  {
    ...
    expectedStart: "2026-09-15",
    duration: "9 months",
    requiredSkills: ["Engineering management", "React/Next.js", "Loyalty platforms"],
    requiredFTE: 6,
    readiness: 74,
    readinessTone: "ready",
    riskFlags: [],
  ...
  {
    id: 16,
    name: "Lloyds digital banking — discovery",
    ...
    expectedStart: "2026-10-01",
    duration: "4 months",
    requiredSkills: ["Applied ML", "Retail banking", "Discovery research"],
    requiredFTE: 3,
    readiness: 42,
    readinessTone: "risk",
    riskFlags: ["UK Data & AI structurally short"],
    owner: "Priya Iyer",
    daysInStage: 13,
  },
  {
    id: 17,
    name: "Barclays API platform — phase 2",
    client: "Barclays",
    market: "London",
    region: "UK",
    practice: "Cloud & Architecture",
    ...
    expectedStart: "2026-11-01",
    duration: "10 months",
    requiredSkills: ["Cloud architecture", "API platforms", "Banking integration"],
    requiredFTE: 5,
    readiness: 78,
    readinessTone: "ready",
    riskFlags: [],
  ...
  {
    id: 18,
    name: "Allianz claims platform — Phase 2",
    client: "Allianz",
    market: "Munich",
    region: "DACH",
    practice: "Engineering",
    ...
    expectedStart: "2026-09-01",
    duration: "11 months",
    requiredSkills: ["Engineering management", "Insurance platforms", "Cloud"],
    requiredFTE: 7,
    readiness: 80,
    readinessTone: "ready",
    riskFlags: [],
  ...
  {
    id: 19,
    name: "Siemens innovation lab — strand 4",
    client: "Siemens",
    market: "Munich",
    region: "DACH",
    practice: "Strategy & Innovation",
    ...
    expectedStart: "2026-10-15",
    duration: "4 months",
    requiredSkills: ["Innovation strategy", "Industrial IoT", "Prototyping"],
    requiredFTE: 4,
    readiness: 82,
    readinessTone: "ready",
    riskFlags: [],
  ...
  {
    id: 20,
    name: "BNP Paribas wealth — discovery",
    client: "BNP Paribas",
    market: "Paris",
    region: "France",
    practice: "Strategy & Innovation",
    ...
    expectedStart: "2026-11-15",
    duration: "3 months",
    requiredSkills: ["Strategy", "Wealth/private banking", "Discovery research"],
    requiredFTE: 3,
    readiness: 76,
    readinessTone: "ready",
    riskFlags: [],
  ...
  {
    id: 21,
    name: "Société Générale service redesign",
    ...
    expectedStart: "2027-01-15",
    duration: "6 months",
    requiredSkills: ["Service design", "Retail banking", "Customer journey mapping"],
    requiredFTE: 4,
    readiness: 70,
    readinessTone: "ready",
    riskFlags: ["Early stage — buyer interest only"],
    owner: "Camille Roux",
    daysInStage: 18,
  },
];
